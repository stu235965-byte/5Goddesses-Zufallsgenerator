...
test('supplied background asset is styled and precached',css.includes('assets/start-hintergrund.png') && sw.includes('./assets/start-hintergrund.png') && fs.existsSync('assets/start-hintergrund.png'));
